...
public class LogImagePreviewItem extends RelativeLayout {
	...
	public LogImagePreviewItem(Context context) {
		super(context);
		init(context);
	}

	public LogImagePreviewItem(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		parentView = (RelativeLayout) inflater.inflate(R.layout.log_image_preview_item, this, true);
